 ...
 *
 * Examples:
 * - /pinkclub-rakutoys/public/index.php             => /pinkclub-rakutoys
 * - /pinkclub-rakutoys/admin/index.php              => /pinkclub-rakutoys
 */
 ...
 * subdirectory (e.g. `/pinkclub-rakutoys/public/`). In that case infer the base
 ...
 * and we detected the app is running under a subdirectory (e.g. /pinkclub-rakutoys),
...
if (!defined('APP_NAME')) {
    define('APP_NAME', 'PinkClub RakuToys');
}
if (!defined('BASE_URL')) {
...
return [
    'db' => $dbConfig,
    'security' => [
        'session_name' => 'pinkclub_rakutoys_session',
    ],
    'rakuten' => [
