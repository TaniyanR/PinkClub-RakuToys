...
$batchOptions = [1, 10, 20, 30, 60, 90, 120, 150, 300];
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $batch = (int)post('item_sync_batch', 30);
...
$currentBatch = (int)($settings['item_sync_batch'] ?? 30);
...
<section class="card">
  ...
  <form method="post" class="stack" style="max-width:980px;">
    ...
    <p>単体キーワード（例: アダルトグッズ）または複合（例: ローター,静音）を入力できます。複合はスペース区切りのAND検索として楽天APIへ渡します。</p>
  ...
  <table class="admin-table">
    <tr><th>ジョブ</th><th>最終実行日時</th><th>成功</th><th>メッセージ</th><th>次回page</th><th>ロック期限</th></tr>
