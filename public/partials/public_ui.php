    ...
    function pcf_item_image(array $item): string
    {
        ...
        if ($rawJson !== '') {
            ...
            if (is_array($raw)) {
                ...
                $candidates[] = pcf_first_image_from_mixed($raw['mediumImageUrls'] ?? null);
                $candidates[] = pcf_first_image_from_mixed($raw['smallImageUrls'] ?? null);
...
if (!function_exists('pcf_item_title')) {
    function pcf_item_title(array $item): string
    {
        ...
        $candidates = [
            ...
            pcf_first_text_from_mixed($raw['itemName'] ?? ''),
