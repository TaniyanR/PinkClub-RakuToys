...
$isRakutenDestination = $host === 'rakuten.co.jp'
    || $host === 'rakuten.com'
    || $host === 'r10.to'
    || str_ends_with($host, '.rakuten.co.jp')
    || str_ends_with($host, '.rakuten.com');
if (!$valid || !in_array($scheme, ['http', 'https'], true) || (!$resolvedMutualLink && !$isRakutenDestination)) {
